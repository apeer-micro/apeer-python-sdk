...
class core:
    def __init__(self):
            ...
            #self._input_json = json.loads('{"WFE_output_params_file":"wfe_module_params_1_1.json", "new_filename": "test.jpg", "input_file":"C:/input/1111.jpg"}')

    def _get_inputs(self):
            """ Get the inputs"""
            try:
                self._wfe_output_params_file = self._input_json.pop('WFE_output_params_file')
                self.inputs = Namespace(**self._input_json)
                return self.inputs
            except KeyError:
                print("Environment variable WFE_INPUT_JSON not found. Please add WFE_INPUT_JSON as an environment variale. Example of WFE_INPUT_JSON: {\"WFE_output_params_file\":\"wfe_module_params_1_1.json\", \"red\":0, \"green\":0.5, \"blue\":0}")
